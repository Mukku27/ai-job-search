...
version: 1.0.0
description: >
  Make sure to use this skill whenever the user mentions job searching on Akademikernes Jobbank, jobbank.dk, or academic/highly-educated positions in Denmark — even without explicit mention. Also for Danish listings, graduate/trainee, Ph.d./postdoc, or work by industry/region. Trigger phrases: jobbank, akademikernes jobbank, jobs denmark, academic jobs denmark, highly educated jobs, graduate/trainee/ph.d./postdoc denmark, studiejob, fuldtidsjob, deltidsjob, vikariat, praktikplads, jobsøgning, søg job, ledige stillinger, it/engineering/marketing/finance/healthcare jobs denmark, remote/fjernarbejde, job københavn/aarhus/odense, nyuddannede, data scientist/developer, projektleder, konsulent.
context: fork
