---
name: behuman
description: Strip the telltale signs of AI writing from any text Claude produces, based on Wikipedia's "Signs of AI writing" field guide, the community catalog of patterns that expose machine-generated text. Use this every time Claude writes, drafts, edits, rewrites, or reviews prose of any kind, including hiring/application answers, interview talking points, cover letters, LinkedIn messages, emails, scripts, social posts, captions, blogs, landing pages, ad copy, WhatsApp messages, summaries, and chat replies. Trigger whenever the user says "make it human", "humanize this", "this sounds like AI", "remove AI words", "de-AI this", or "BeHuman", and also by default for fresh writing (especially application Q&A and interview prep), because these patterns creep in silently unless actively suppressed.
---
